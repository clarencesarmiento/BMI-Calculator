...
class CalculateFrame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.frame_title = self.create_label(self, text='Calculate', font_used='montserrat', fontsize=18)
        ...
        self.result = self.create_label(self, text='BMI: 0.00', font_used='montserrat', fontsize=16)
        self.result.grid(row=7, column=0, sticky='w')

        self.category = self.create_label(self, text='Category:', font_used='montserrat', fontsize=16)
    ...
    def update_bmi_and_category(self, ):
        ...
        self.result.configure(text=f'BMI: {bmi:.2f}')

        category = get_bmi_category(bmi)
        self.category.configure(text=f'Category: {category}')
